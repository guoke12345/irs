...
public interface IStudyDao {
	...
	public Pagination<Study> studyByone(int pageno,int pageSize,int studyOneName_id);
	public Pagination<Study> studyBytwo(int pageno,int pageSize,int studyTwoName_id);
